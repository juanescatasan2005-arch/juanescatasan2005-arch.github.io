...
<head>
    ...
    <style>
        body {
            background-image: url('4FN.png'); /* Fondo con la imagen 4FN.png */
            ...
            color: #ffffff; /* Letras blancas para resaltar */
        }
        .container {
            max-width: 1200px;
            background-color: transparent; /* Fondo transparente */
        ...
        .card-header {
            background-color: #2a2a72; /* Azul oscuro para contraste */
            color: white;
        }
        .btn-link {
            color: white;
        ...
        .table th {
            background-color: #4b5e9b; /* Azul medio para tablas */
        }
        .lead {
            font-size: 1.5rem; /* Mayor tamaño para resaltar */
            font-weight: bold; /* Negrita para destacar */
            color: #1e3a8a; /* Azul oscuro para la introducción */
            text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.3); /* Sombra para legibilidad */
        }
        .image-container {
            text-align: center;
            margin: 20px 0;
        ...
        .btn-primary {
            background-color: #2a2a72; /* Azul oscuro para botones */
            border-color: #2a2a72;
        ...
        .card-body {
            background-color: transparent; /* Fondo transparente */
            border-radius: 0 0 10px 10px; /* Bordes más redondeados */
            padding: 20px;
            color: #1e3a8a; /* Azul oscuro para texto dentro de card-body */
        }
        h1, h4 {
            color: #1e3a8a; /* Azul oscuro para títulos */
            font-weight: bold; /* Títulos en negrilla */
            text-shadow: 1px 1px 4px rgba(0, 0, 0, 0.4); /* Sombra para resaltar */
        }
        ul {
            list-style-type: "⭐ "; /* Icono de estrella para diversión */
            padding-left: 30px;
            color: #1e3a8a; /* Azul oscuro para las listas */
        }
        .fun-note {
            font-style: italic;
            color: #ffffff; /* Letras blancas para notas */
            margin-top: 10px;
        }
        ul strong {
            color: #1e3a8a; /* Azul oscuro más intenso para títulos de items */
            font-weight: 800; /* Títulos más gruesos */
        }
    </style>
</head>
<body>
    <div class="container">
        ...
        <p class="lead text-center mb-5">¡Descubre cómo organizar datos como un experto! Esta página te enseña las formas normales (1FN, 2FN, 3FN) con ejemplos divertidos de una tienda de zapatos. ¡Explora, aprende y juega con los detalles!</p>
